...
class PeeshooterPlayer : public Player
{
public:
	PeeshooterPlayer(bool facing_right = true) : Player(facing_right)
	{
		...
		animation_idle_left.set_intreval(75);
		animation_idle_right.set_intreval(75);
		animation_run_left.set_intreval(75);
		animation_run_right.set_intreval(75);
		animation_attack_ex_left.set_intreval(75);
		animation_attack_ex_right.set_intreval(75);
		animation_die_left.set_intreval(150);
		animation_die_right.set_intreval(150);
